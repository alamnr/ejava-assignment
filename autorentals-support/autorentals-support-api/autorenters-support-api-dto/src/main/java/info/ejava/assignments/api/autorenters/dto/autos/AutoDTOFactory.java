...
public class AutoDTOFactory {
    ...
    public int passengers() { return faker.number().numberBetween(1,5); }
    ...
    public Vehicle vehicle() { return faker.vehicle(); }
    private final StreetAddressDTOFactory locationFactory = new StreetAddressDTOFactory();
    public StreetAddressDTO location() { return locationFactory.make(); }
    public String username() { return faker.name().username().replaceAll("\\.",""); }

    @SafeVarargs
    public final AutoDTO make(Consumer<AutoDTO>... visitors) {
        Vehicle vehicle = vehicle();
        AutoDTO result = AutoDTO.builder()
                .id(null)
                .dailyRate(dailyRate())
                .fuelType(fuelType())
                .make(vehicle.make())
    ...
    public AutosDTOFactory listBuilder() { return new AutosDTOFactory(); }
