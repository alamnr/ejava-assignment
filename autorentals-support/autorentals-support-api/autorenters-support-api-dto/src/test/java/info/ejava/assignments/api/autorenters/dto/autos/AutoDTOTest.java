...
public class AutoDTOTest {
    ...
    private AutoDTOFactory autosFactory = new AutoDTOFactory();

    private Stream<Arguments> autos() {
        return Stream.of(
                Arguments.of(autosFactory.make()),
                Arguments.of(autosFactory.make(withId)),
                Arguments.of(new AutoListDTO(autosFactory.listBuilder().make(3, withId)))
        );
    }
