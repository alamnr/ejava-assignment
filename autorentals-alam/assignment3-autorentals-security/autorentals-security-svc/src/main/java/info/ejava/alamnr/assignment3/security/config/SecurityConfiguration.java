...
public class SecurityConfiguration {
    ...
    public static class PartA1_AnonymousAccess {
        ...
        @Bean
        @Order(0)
        public SecurityFilterChain configureaAnonymousProfile(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception{
    ...
    public static class PartA2_AuthenticatedAccess {
        ...
        @Bean
        @Order(0)
        public SecurityFilterChain  configureAuthenticatedAndUserDetailsProfile(HttpSecurity http) throws Exception  {
            // requirement -2
             ...
             */
                ...
                http.authorizeHttpRequests(cfg-> cfg.requestMatchers("/api/autorentals").permitAll());
    ...
    public static class PartA_Authorizatonnn {
            ...
            @Bean
            @Order(0)
            public SecurityFilterChain configureAuthorizationProfile(HttpSecurity http, AuthenticationManager authenticationManager,
                ...
                // path based authorization constraint
