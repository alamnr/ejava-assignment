...
public interface AutoRentalsJSONHttpIfaceMapping extends AutoRentalsAPI {
    ...
    @GetExchange(url = AUTO_RENTAL_PATH,accept = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PostExchange(url = AUTO_RENTAL_QUERY_PATH, accept = MediaType.APPLICATION_JSON_VALUE)
    ResponseEntity<AutoRentalListDTO> queryAutoRental(@RequestBody AutoRentalDTO probe, 
                                                        @RequestParam(name = "pageNumber", required = false) Integer pageNumber,
                                                        @RequestParam(name = "pageSize", required = false) Integer pageSize) ;

    @GetExchange(url = AUTO_RENTALS_PATH, accept = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutExchange(url = AUTO_RENTAL_PATH,contentType = MediaType.APPLICATION_JSON_VALUE, accept = MediaType.APPLICATION_JSON_VALUE)
