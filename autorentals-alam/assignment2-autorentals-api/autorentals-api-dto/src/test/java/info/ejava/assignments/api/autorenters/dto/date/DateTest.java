...
public class DateTest {
    ...
    public static final ZonedDateTime DATE = ZonedDateTime.of(1776,7,4,5,2,3,123456789,ZoneId.of("UTC"));
    ...
    @ParameterizedTest
    @MethodSource("dateText")
    void parse_custom(String dateText, ZonedDateTime dateValue){
      ...
      //  Assertions.assertThat(ldt).isEqualTo(dateValue.toLocalDateTime());
    }
